package com.example.spring_boot_swagger;
...
public class Swagger2Config{
    ...
    public Docket createRestfulApi() {//api文档实例
        return new Docket(DocumentationType.SWAGGER_2)//文档类型：DocumentationType.SWAGGER_2
                ...
                .select()//构建api选择器
                .apis(RequestHandlerSelectors.basePackage("com.example.spring_boot_swagger.controller"))//api选择器选择api的包
